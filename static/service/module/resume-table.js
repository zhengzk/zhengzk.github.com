base.clazz('base.ResumeTable',function(_cfg){
		...
		createLeft:function(text){
			...
			$(_div).append(_col).addClass('inline').css({'border-right':'2px solid #0099FF','padding':'5px 0px 0px'});
			return _div;
		},
		createRight:function(data){
			...
			$(_left).addClass('inline').css({'border-top':'2px solid #0099FF','width':'15px','height':'10px','margin':'16px 10px 0px 0px'});
