 ...
 */
 //commfunc
base.clazz('base.CommonFunction',function() {
    var own = this;
    return {
        //button  return:obj
		getButton: function(_text, cb_click, _type) {
			return new base.component.Button({
				text: _text,//按钮显示文本
				cb_click: cb_click,//按钮可用时执行的回掉
				type: _type//button大小尺寸标识 默认为标准尺寸
			});
		},
		getBrightButton: function(_text, cb_click, _type) {
			return new base.component.Button({
				text: _text,//按钮显示文本
				cb_click: cb_click,//按钮可用时执行的回掉
				type: _type,//button大小尺寸标识 默认为标准尺寸
				style:base.component.Button.style.bright
			});
		},
		getGrayButton: function(_text, cb_click, _type) {
			return new base.component.Button({
				text: _text,//按钮显示文本
				cb_click: cb_click,//按钮可用时执行的回掉
				type: _type,//button大小尺寸标识 默认为标准尺寸
				style:base.component.Button.style.gray
			});
		},
		getClassNavi:function(){
			/*
			base.componet.ClassifyNavi
				{
					title:'',
					cb_click:null,
					data:null,
